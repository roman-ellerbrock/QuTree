...
template SumOfProductsOperator<cd> operator*(const PO<cd>& M, const SOP<cd>& A);
template SumOfProductsOperator<cd> operator*(const SOP<cd>& A, const PO<cd>& M);
...
template SumOfProductsOperator<d> operator*(const PO<d>& M, const SOP<d>& A);
template SumOfProductsOperator<d> operator*(const SOP<d>& A, const PO<d>& M);
