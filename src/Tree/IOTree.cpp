...
namespace IOTree {
	...
	void Occupancy(const TensorTree<T>& Psi, const TTBasis& basis, ostream& os) {
		...
		MatrixTreeFunctions::Contraction(Rho, Psi, basis, true);
	...
	template <typename T>
	void Leafs(const TensorTree<T>& Psi, const MatrixTree<T>& Rho, const TTBasis& basis, ostream& os) {
...
template void IOTree::Leafs<cd>(const TensorTree<cd>& Psi, const MatrixTree<cd>& Rho, const TTBasis& basis, ostream& os);
template void IOTree::Leafs<d>(const TensorTree<d>& Psi, const MatrixTree<d>& Rho, const TTBasis& basis, ostream& os);

template FactorMatrix<cd> IOTree::LeafDensity(const TensorTree<cd>& Psi, const MatrixTree<cd>& Rho, const Leaf& leaf, const TTBasis& basis);
template FactorMatrix<d> IOTree::LeafDensity(const TensorTree<d>& Psi, const MatrixTree<d>& Rho, const Leaf& leaf, const TTBasis& basis);
