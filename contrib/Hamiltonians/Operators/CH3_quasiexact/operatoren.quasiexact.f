...
c######################################################################
      ...
      subroutine h init (koeff,diag,dim)
...
c Bestimmung der diagonalen Komponenten des Hamilton-Operators
      ...
      call diagon(diag,dim,k zahl)
      return
      end

c--------------------------------------------------------------

      subroutine diagon(diag,dim,k zahl)
...
c##############################################################
      ...
      subroutine h (mode,teil,h psi,psi,dim,matrix,trafo,ort)
...
c    .                                            46 ! c3v 66 term
 ...
 5000 goto (
     .         1,  1,  1,                         ! 11,22,33 terms
c     .        52, 53, 58, 58,                     ! the 44 term   
c ERROR corrected on 06/10/2006
     .        52, 53, 56, 58,                     ! the 44 term
c    .         1,
...
c    .                                            1 ! c3v 66 term
 ...
 6000 goto (
     .         1,  1,  1,                         ! 11,22,33 terms
c     .        53, 52, 58,  1,                     ! the 44 term 
c ERROR corrected on 06/10/2006
     .        53, 52, 56,  1,                     ! the 44 term
c    .         1,
