...
#ifndef NUMBERPARTITIONING_H
#define NUMBERPARTITIONING_H
#include "SumOfProductsOperator.h"
#include "Pauli.h"

class NumberPartitioning: public SOP {
	/*!
...
public:
	/// Constructor
	explicit NumberPartitioning(const mctdhBasis& basis) { Initialize(basis); }

	/// Destructor
	~NumberPartitioning() = default;
