...
c     Funktions
      double precision morseexp !morse exponent
...
c     transforming distances to tunable morse coordiantes
      tmcccl = 1.d0 
     . - dexp(-morseexp(dccl,p(pst(1,2)),1)*(dccl-dcclequi)) 
      tmcch1 = 1.d0 - dexp(-morseexp(dch1,p(pst(1,3)),2)*(dch1-dchequi))
      tmcch2 = 1.d0 - dexp(-morseexp(dch2,p(pst(1,3)),2)*(dch2-dchequi))
      tmcch3 = 1.d0 - dexp(-morseexp(dch3,p(pst(1,3)),2)*(dch3-dchequi))
c      tmcch1 = dch1
c      tmcch2 = dch2
c      tmcch3 = dch3
...
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      double precision morseexp !prefactor of exponent and returned value
